<div class="emp-page bf-list-page w-full">
    ...
    <div class="emp-head">
        ...
        <div class="emp-actions">
            @if(\App\Filament\Resources\FoodSafetyAuditResource::canCreate())
                <a
                    href="{{ \App\Filament\Resources\FoodSafetyAuditResource::getUrl('create') }}"
                    wire:navigate
                    class="emp-btn"
                >
                    <i class="fa-solid fa-rotate"></i>
                    {{ __('food_safety.actions.create_data') }}
                </a>
            @endif
            <button
                type="button"
