...
return [
    ...
    'placeholders' => ['audit_reason' => 'VD: Khách đổi món đột xuất', 'select_dish' => 'Chọn món ăn...', 'portions' => 'Suất', 'search_keyword' => 'Tìm kiếm theo công ty, tuần...', 'search_kitchen' => 'Tìm tên bếp ăn...'],
    ...
    'actions' => ['save_draft' => 'Lưu nháp', 'send_customer' => 'Đã gửi khách hàng', 'lock' => 'Chốt thực đơn', 'reset_filters' => 'Cài lại bộ lọc', 'edit' => 'Chỉnh sửa', 'export_excel' => 'Xuất Excel', 'back' => 'Quay lại', 'remove_dish' => 'Bỏ món này', 'create_week' => 'Tạo thực đơn tuần', 'create_day' => 'Tạo thực đơn ngày', 'add_dish' => 'Thêm món ăn'],
