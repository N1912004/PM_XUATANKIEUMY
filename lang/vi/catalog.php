...
$translations = [
    ...
    'shift' => ['navigation' => 'Cấu hình ca làm việc', 'label' => 'Ca làm việc', 'fields' => ['name' => 'Tên ca', 'start_time' => 'Giờ bắt đầu', 'end_time' => 'Giờ kết thúc'], 'placeholders' => ['name' => 'Ví dụ: Ca 1'], 'table' => ['time_range' => 'Khung giờ']],
];
