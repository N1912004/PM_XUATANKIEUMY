...
$translations = [
    ...
    'kitchen' => [
        ...
        'fields' => ['name' => 'Tên nhà ăn / bếp', 'area' => 'Thuộc khu vực', 'type' => 'Phân loại', 'capacity' => 'Công suất phục vụ (suất/ngày)', 'manager' => 'Phụ trách'],
...
$translations['kitchen']['list'] = [
    ...
    'kpi' => [
        ...
        'managers_label' => 'Phụ trách', 'managers_note' => 'Theo cơ sở',
    ],
