...
$translations = [
    ...
    'shift' => ['navigation' => 'Shift configuration', 'label' => 'Shifts', 'fields' => ['name' => 'Shift name', 'time_from' => 'Start time', 'time_to' => 'End time'], 'placeholders' => ['name' => 'E.g. Shift 1'], 'helpers' => ['constraints' => 'Maximum 12 hours. An earlier end time means the following day.'], 'validation' => ['time_required' => 'Start and end times are required.', 'different_times' => 'The end time must differ from the start time.', 'max_duration' => 'A shift may not exceed 12 hours.'], 'table' => ['time_range' => 'Time range']],
];
