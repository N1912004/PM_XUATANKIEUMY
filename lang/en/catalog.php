...
$translations = [
    ...
    'kitchen' => [
        ...
        'fields' => ['name' => 'Kitchen name', 'area' => 'Belongs to area', 'type' => 'Classification', 'capacity' => 'Serving capacity (portions/day)', 'manager' => 'Person in charge'],
...
$translations['kitchen']['list'] = [
    ...
    'kpi' => [
        ...
        'managers_label' => 'Persons in charge', 'managers_note' => 'By facility',
    ],
